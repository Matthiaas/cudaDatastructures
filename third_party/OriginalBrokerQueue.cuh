#ifndef INCLUDED_ORIG_QUEUE_BROKER
#define INCLUDED_ORIG_QUEUE_BROKER
...
public:
	...
	__device__ OriginalBrokerQueue()
	{
		init();
	}
	...
	__device__ inline bool push(const T& data, bool insert)
	{
		if (!insert) {
			return;
		}
	...
	__device__ inline bool pop(T* data, bool remove)
	{
		if (!remove) {
			return;
		}
