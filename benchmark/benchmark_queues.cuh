...
struct CpuGpuQueueBenchmark : public QueueBenchmark {
    ...
    virtual void GpuRun(size_t num_iter, size_t num_blocks, size_t num_threads) override {
    ...
    virtual void CpuCleanup() override {
        delete buffer;
    }
...
//     QueueBenchmark<BrokerQueue<int64_t, 4 * BLOCKSIZE>> benchmark("BrokerQueue");
//     QueueBenchmark<CASRingBuffer<int64_t, -1, 4 * BLOCKSIZE>> benchmark2("CASRingBuffer");
//     QueueBenchmark<CASRingBufferRequest<int64_t, -1, 4 * BLOCKSIZE>> benchmark3("CASRingBufferRequest");
